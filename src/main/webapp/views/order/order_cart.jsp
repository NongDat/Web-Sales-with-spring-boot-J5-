...
<body>
	<div class="container-fluid p-0" style="background-color: #EEEEEE">
		...
		<!-- 					END MENU							 -->
		<!--  -->
		<form method="POST" action="/home/order/pay">
			<div class="row mt-1" style="height: 800px">
				<div style="padding: 0px">
					<h1 class="text-primary text-center bg-info pt-3 pb-3">Thanh
						Toán</h1>
					<c:if test="${not empty sessionScope.orderDetail }">
						<p class="text-danger text-center">${sessionScope.orderDetail }</p>
						<c:remove var="orderDetail" scope="session" />
					</c:if>
				</div>
				<div class="row" style="height: 5px">
					<div class="row">
						<h2 class="text-danger m-3">
							<i class="bi bi-geo-alt-fill"></i> <b>Địa Chỉ Nhận Hàng</b>
						</h2>
					</div>
					<div class="row">
						<div class="col-sm-3 offset-1">
							<b>Họ tên:
								<h3 style="display: inline-block;">${sessionScope.account.fullname}</h3>
							</b>
						</div>
						<div class="col-sm-4">
							<b>Địa chỉ: <input name="address" style="width: 80%"
								type="text" placeholder="Address"></b>
						</div>
						<div class="col-sm-3">
							<b>Ngày Tạo: </b><b>${sessionScope.date }</b>
						</div>
					</div>
				</div>
				<hr>

				<article class="col-sm-6 offset-1">
					<h2>
						<u>Sản Phẩm</u>
					</h2>
					<div class="row">
						<table>
							...
							<tr>
								<td></td>
								<td class="text-danger" colspan=2><b>Tổng</b></td>
								<td class="text-danger"><b>$ ${NoOfItems}</b></td>
							</tr>
						</table>
					</div>
				</article>
				<aside class="col-sm-3">
					<div class="card mb-2">
						<div class="card-body d-flex justify-content-between">
							<b>Sản Phẩm:</b> <b> $ ${total}</b>
						</div>
						<div class="card-body d-flex justify-content-between">
							<b>Vận chuyển:</b> <b> $ 0</b>
						</div>
						<div class="card-header  d-flex justify-content-between">
							<b>Tổng:</b> <b class="text-danger"> $ ${total}</b>
						</div>
					</div>
					<div>
						<a class="btn btn-warning text-white btn-outline-primary"
							href="/shoppingCart/list">Thay Đổi</a>
