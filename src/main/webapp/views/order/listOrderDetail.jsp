	...
	<div class="container-fluid p-0" style="background-color: #EEEEEE">
		...
		<div class="row m-3">
			...
			<div class="col-sm-10 offset-1">
				<!-- 	admin	 -->
				<c:if test="${sessionScope.account.role == true }">
					<a class="btn btn-warning mb-3" href="/home/order/admin/list-order"
						style="width: 100px; height: 40px">Quay Lại</a>
				</c:if>
				<!-- 	user	 -->
				<c:if test="${sessionScope.account.role != true }">
					<a class="btn btn-warning mb-3"
						href="/home/order/showOrderByAccount"
						style="width: 100px; height: 40px">Quay Lại</a>
				</c:if>
					...
					<c:forEach var="item" items="${listOrderDetail}">
						<tr>
							...
							<td class="text-center"><a
								href="/home/product/detail/${item.id }"><img
							...
							<td>${item.price }</td>
							<td>${item.quantity }</td>
							<td class="text-danger">$ ${item.quantity * item.price}</td>
