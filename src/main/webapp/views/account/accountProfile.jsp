...
<body>
	<div class="container-fluid p-0" style="background-color: #EEEEEE">
		...
		<div class="container rounded bg-white mt-5 mb-5">
			<form:form action="/home/account/Save" method="POST"
				modelAttribute="AccountDTO">
				<div class="row">
					<div class="col-md-3 offset-1 border-right">
						<div
							class="d-flex flex-column align-items-center text-center p-3 py-5">
							<img class="rounded-circle mt-5 border border-info" width="150px"
								src="${pageContext.request.contextPath}/images/${AccountDTO.photo }">
							<input  value="${AccountDTO.photo }" name="img" hidden="true"> 
							<span class="font-weight-bold"><b>${AccountDTO.fullname}</b></span><span
								class="text-black-50">${AccountDTO.email}</span><span>
							</span>
						</div>
						<div class="row m-3">
							<a><span>Đơn Mua</span></a> <a><span>Thông Báo</span></a> <a><span>Kho
									Voucher</span></a>
						</div>
					</div>
						...
						<div class="p-3 py-5">
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="row mt-2">
										<div class="col-md-12">
											<label class="labels"><b>UserName:</label></b>
											<form:input path="username" style="width:100%" class="" />
									...
									<div class="row mt-3">
										<div class="col-md-12">
											<label class="labels"><b>fullname:</b></label>
											<form:input path="fullname" style="width:100%" class="" />
											<form:errors path="fullname" element="div"
												cssClass="text-danger" />
										</div>
										<div class="col-md-12">
											<label class="labels"><b>Password:</b></label>
											<form:input path="password" style="width:100%" class="" />
											<form:errors path="password" element="div"
												cssClass="text-danger" />
										</div>
										<div class="col-md-12">
											<label class="labels"><b>email:</b></label>
											<form:input path="email" style="width:100%" class="" />
											<form:errors path="email" element="div"
												cssClass="text-danger" />
										</div>
										<div class="col-md-12">
											<label class="labels"><b>Photo:</b></label>
											<form:input path="photo" type="file" />
										</div>
										<div class="col-md-12">
											<label class="labels"><b>Role:</b></label>
											<form:radiobutton path="role" value="true" label="Admin" />
											<form:radiobutton path="role" value="false" label="User" />
										</div>
									</div>
									<!--  -->
									<hr>
									<div class="mt-5 text-center">
										<button class="btn btn-success text-white btn-outline-primary">
											Save</button>
										<a class="btn btn-danger text-white btn-outline-primary"
											href="/home/account/listAccount">Cancel</a>
									</div>
								</div>
							</div>
