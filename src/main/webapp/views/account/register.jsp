		...
		<section class="h-100" style="width: 100%">
			<div class="container py-1 h-100">
				<div class="row d-flex justify-content-center align-items-center h-100">
					<form:form action="/home/account/register" method="POST" modelAttribute="AccountDTO">
						<div class="col">
								...
								<div class="row g-0">
									...
									<div class="col-xl-6">
										<div class="card-body p-md-5 text-black">
											<h3 class="mb-5 text-uppercase">Custom registration form</h3>
											<c:if test="${not empty sessionScope.msgRegister }">
												<div class="alert alert-danger">
													${sessionScope.msgRegister}
												</div>
												<c:remove var="msgRegister" scope="session"/>
											</c:if>
											...
											<div class="form-outline mb-4">
												...
												<form:errors path="photo"  element="div" cssClass="text-danger"/>
											</div>
											...
											<div class="text-center">
												...
												<a class="btn btn-warning" href="/home">Hủy</a>
											</div>
										</div>
									</div>
								</div>
