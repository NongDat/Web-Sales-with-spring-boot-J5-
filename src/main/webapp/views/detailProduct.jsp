...
<body>
	<div class="container-fluid p-0" style="background-color: #EEEEEE">
		...
		<!-- 					END MENU							 -->
		<!-- 						Chi tiết sản phẩm					 -->
			<h1 class="text-white text-center bg-primary">Chi Tiết Sản Phẩm</h1>
		<div class="row m-5">
			<article class="col-sm-3  offset-sm-3">
				<div class="card" style="width: 18rem;">
					<img src="${pageContext.request.contextPath}/images/${product.image}" class="card-img-top" alt="...">
				</div>
			</article>
			<aside class="col-sm-3">
				<ul >
					<li><b>Tên:</b>	${product.name}</li>
					<li><b>Giá:</b>	${product.price}</li>
					<li><b>Ngày Tạo:</b>	${product.createDate}</li>
					<li><b>Loại:</b>	${product.category.name}</li>
					<li><b>Tình Trạng:</b>	${product.available == true? "Còn Hàng" : "Hết Hàng"}</li>
				</ul>
				<a href="/shoppingCart/add/${product.id}" class="btn btn-primary"><i
										class="bi bi-cart3"></i> <b> Thêm</b></a>
			</aside>
		</div>
		<h1 class="text-white text-center bg-warning">Sản Phẩm Liên Quan</h1>
		<div>
			<div class="row">
					<c:forEach var="item" items="${listProductRelationShip}">
							...
							<div class="card border border-primary"
								...
								<div class="card-body" style="height: 100px">
									<div class="row">
										...
										<div class="col-sm-6">
											<p class="card-text text-center">${item.available != true? "Còn Hàng" : "Hết Hàng"}
											</p>
										</div>
									</div>
								</div>
								<div class="card-footer ">
									<a href="/shoppingCart/add/${item.id}" class="btn btn-primary"><i
										class="bi bi-cart3"></i> <b> Thêm</b></a>
									<a href="/home/product/detail/${item.id }" class="btn btn-warning "><i class="bi bi-ticket-detailed-fill"></i> Chi tiết</a>
								</div>
							</div>
						</div>
