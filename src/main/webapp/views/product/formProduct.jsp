...
<body>
	<div class="container-fluid p-0" style="background-color: #EEEEEE">
		<nav
			...
			<div class="container-fluid">
				<a class="navbar-brand" href="/home"> <img
					src="${pageContext.request.contextPath}/images/logo.png" style="width: 80px; height: 60px;" alt="">
		...
		<!--  -->
		<div class="header text-center border-bottom border-secondary border-5">
			<div class="row">
				<div class="col-sm-12">
					<a href="/home"><img
		...
		<!-- 					END MENU							 -->
		<div class="row m-3">
			<form:form action="/home/product/save" method="post"
				modelAttribute="ProductDTO">
				<form:hidden path="id" />
				<div class="row">
					<div class="col-sm-3 offset-1">
						<input name="img" hidden="true" value="${ProductDTO.image }">
						<b>Hình Ảnh</b> <img class="border border-primary border-2 mb-4"
							src="${pageContext.request.contextPath}/images/${ProductDTO.image }"
							style="height: 200px; width: 200px" class="card-img-top"
							alt="...">
						<form:input path="image" type="file" style="width:100%" />
					</div>
					<div class="col-sm-7">
						<div class="row m-3">
							...
							<div class="col-sm-4">
								<b>Loại Sản Phẩm</b>
								<form:select path="categoryId" class="form-control" style="width:100%">
									<form:option value="default">--Lựa Chọn--</form:option>
									<c:forEach var="item" items="${listCategory}">
										<form:option value="${item.id}">${item.name}</form:option>
									</c:forEach>
								</form:select>
								<form:errors path="categoryId" element="div" cssClass="text-danger"/>
							</div>
						</div>
						<div class="row m-3">
							<div class="col-sm-4 offset-2">
								<b>Giá Sản Phẩm</b>
								<form:input path="price" type="number" style="width:100%" />
							...
							<div class="col-sm-4">
								...
								<div style="width: 100%">
									...
									<form:radiobutton path="available" style="margin-left:10px"
										value="false" label="Hết" />
								</div>
							</div>
						</div>
						...
						<div class="row m-3">
							<div class="col-sm-4 offset-2">
								<b>Ngày Tạo</b>
								<form:input path="createDate" type="date" style="width:100%" />
								<form:errors path="createDate" element="div" cssClass="text-danger"/>
							</div>
				...
				<div class=" row  offset-4">
					...
					<a class="btn btn-danger" style="margin-left: 16px; width: 100px"
						href="/home/product">Cancel</a>
				</div>
			</form:form>
		</div>
		<!-- 						FOOTER 									 -->
